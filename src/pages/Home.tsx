    ...
    <div className="container-app">
      <section className="py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5Sxl font-bold text-white mb-6">Gerencie suas finanças com o <span className="text-primary-500">ControleJá</span></h1>
            ...
            <Button className="tex-center px-6 py-3" onClick={() => navigate("/login")}>Começar Agora</Button>
          </div>
          </div>          
        </div>
      </section >
      ...
      <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
         <div className="container-app">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Recursos do ControleJá</h2>
      ...
      <section className="py-12 md:py-20">
        <div className="bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700">
          ...
          <p className="text-white text-opacy-90 max-w-2xl mx-auto mb-8">Comece a usar o ControleJá hoje mesmo e tenha o controle total sobre seu dinheiro. É gratuito e fácil de usar!</p>
