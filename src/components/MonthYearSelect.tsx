        ...
        <div className="flex items-center justify-between bg-gray-900 rounded-lg p-3 border border-gray-700">
           ...
           >
            ...
            <div className="flex gap-4">
                ...
                id="month-select" 
                className="cursor-pointer bg-gray-800 border border-gray-700 rounded-md py-1 px-3 text-sm font-medium text-gray-100 focus: outline-none focus:ring-2 focus:ring-primary-500  mr-2">
                ...
                value={year}
                className="cursor-pointer bg-gray-800 border border-gray-700 rounded-md py-1 px-3 text-sm font-medium text-gray-100 focus: outline-none focus:ring-2 focus:ring-primary-500">
                    {years.map((name) => (
